	...
	return (
		<div className="grid lg:grid-cols-3 h-full">
			...
			>
				<Logo mode="dark" />
				<div>
					<h3 className="text-white mb-4">Jump start your project with Demo</h3>
					<p className="text-lg text-white opacity-80 max-w-[700px]">Demo comes with a complete set of UI components crafted with Tailwind CSS, it fulfilled most of the use case to create modern and beautiful UI and application</p>
				</div>
