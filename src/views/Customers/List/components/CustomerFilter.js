...
import { getCustomers, setFilterData, initialTableData } from '../store/dataSlice'
import {
	Input,
	Button,
	Checkbox,
...
const FilterForm = forwardRef(({ onSubmitComplete }, ref) => {
	...
	const sortedColumn = useSelector((state) => state.customerListSlice.state.sortedColumn)
